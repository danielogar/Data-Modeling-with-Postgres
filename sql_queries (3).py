...
songplay_table_create = ("""CREATE TABLE IF NOT EXISTS songplays (songplay_id SERIAL PRIMARY KEY, start_time timestamp, user_id int, level text, song_id varchar, artist_id varchar, session_id int, location varchar, user_agent varchar);""")
...
song_table_create = ("""CREATE TABLE IF NOT EXISTS songs (song_id varchar NOT NULL, title text, artist_id varchar, year int, duration float, PRIMARY KEY (song_id));
""")
